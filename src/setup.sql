...
INSERT INTO biglietti (id_partecipante, tipo, giorni) VALUES
(3, 'Biglietto Giornaliero', 'Venerdi'),
(4, 'Pass 2 Giorni', 'Sabato,Domenica'),
(5, 'Full Pass', 'Venerdi,Sabato,Domenica');
